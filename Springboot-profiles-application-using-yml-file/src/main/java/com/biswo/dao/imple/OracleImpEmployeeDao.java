...
@Repository
@Profile({"uat","prod"})
public class OracleImpEmployeeDao implements IMEmployeeDao {
	...
	private static final String GET_EMP_DESIG = "SELECT EMPNO,ENAME,JOB,SAL,DEPTNO FROM EMPLOYEE WHERE JOB IN(?,?,?) ORDER BY JOB";

	@Override
	public List<Employee> getEmployeesByDesignation(String desg1, String desg2, String desg3) {
		System.out.println("Data-source object in used in OracleImpEmployeeDao:"+dataSource.getClass());
		//Create the list
